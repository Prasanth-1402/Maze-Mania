...
export function MazeCanvas({ maze, player, end, theme }) {
    const wrapperRef = useRef(null);
    const canvasRef = useRef(null);
    const animationRef = useRef(null);
    const displayPosRef = useRef(player);
    const targetPosRef = useRef(player);
    ...
    useEffect(() => {
        ...
        const loadSprite = (rawUrl, assign, setLoaded, attempt = 0) => {
        ...
        loadSprite(new URL("../../images/alien.png", import.meta.url).href, (sprite) => {
            alienRef.current = sprite;
        }, setAlienLoaded);
        loadSprite(new URL("../../images/home.png", import.meta.url).href, (sprite) => {
    ...
    return (_jsx("div", { className: "maze-wrap", ref: wrapperRef, children: _jsx("canvas", { ref: canvasRef, "aria-label": "Maze canvas" }) }));
}
